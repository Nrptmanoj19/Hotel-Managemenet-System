...
class Register:
    def __init__(self,root):
        ...
        #bg image
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\nrptm\Desktop\5th sem textbooks\dbms h\login1.png")
        ...
        b1=Button(frame,image=self.photoimage1,borderwidth=0,cursor="hand2",font=("times now roman",15,"bold"),fg="white",bg="black")
