...
class Roombooking:
  ...
  #variables
        ...
        img3=Image.open(r"C:\Users\nrptm\Desktop\5th sem textbooks\dbms h\bed.jpg")    #converts into backward slash
        img3=img3.resize((520,200),Image.ANTIALIAS)         #antialias coverts high level image to low level
   ...
   #update function
    def update(self):
        if self.var_contact.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",username="root",password="1234",database="management")
            my_cursor=conn.cursor()
            my_cursor.execute("update room1 set check_in=%s,check_out=%s,roomtype=%s,roomavailable=%s,meal=%s,noOfdays=%s where Contact=%s",(
...
#search system
    ...
    def total(self):
        ...
        elif (self.var_meal.get()=="BreakFat" and self.var_roomtype.get()=="Duplex"):
            q1=float(500) 
            q2=float(1000)   
            q3=float(self.var_noofdays.get())
            q4=float(q1+q2)
